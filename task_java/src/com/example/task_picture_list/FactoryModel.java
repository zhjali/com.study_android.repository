...
/**
 * A model of a factory; at the moment this model just contains machine
 * locations. However, the factory also provides support for undo by storing off
 * mementos each time the factory configuration changes.
 */
public class FactoryModel {
	...
	public void notifyListeners() {
		for (int i = 0; i < listeners.size(); i++)
			((ChangeListener) listeners.get(i)).stateChanged(new ChangeEvent(
					this));
	}
}