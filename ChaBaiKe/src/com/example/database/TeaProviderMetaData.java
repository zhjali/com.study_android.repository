...
public class TeaProviderMetaData {
	...
	public static final String TABLE_VIEW_PAGER_NAME = "viewpager";
	...
	public static final class TableMaindataMetaData implements BaseColumns {
		...
		public static final String CATEGORY_TOU_TIAO = "tou_tiao";
		public static final String CATEGORY_BAI_KE = "bai_ke";
		public static final String CATEGORY_ZI_XUN = "zi_xun";
		public static final String CATEGORY_JING_YING = "jing_ying";
		public static final String CATEGORY_SHU_JU = "shu_ju";
